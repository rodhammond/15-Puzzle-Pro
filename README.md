...
![15-Puzzle Game Dashboard](components/15-Puzzle%20Game%20Dashboard.png)
...
Because the combinations of the 15 puzzle can be generated by 3-cycles, it can be proved that the 15 puzzle can be represented by the **alternating group A<sub>15</sub>**.<sup>[15]</sup> In fact, any 2k &minus; 1 sliding puzzle with square tiles of equal size can be represented by **A<sub>2k&minus;1</sub>**.
...
The number of possible positions of the 24 puzzle is <sup>25!</sup>&frasl;<sub>2</sub> &approx; 7.76 &times; 10<sup>24</sup>, which is too many to calculate "God's number" feasibly using brute-force methods. In 2011, lower bounds of 152 single-tile moves or 41 multi-tile moves had been established, as well as upper bounds of 208 single-tile moves or 109 multi-tile moves.<sup>[7][8][9][10]</sup> In 2016, the upper bound was improved to 205 single-tile moves.<sup>[11]</sup>
